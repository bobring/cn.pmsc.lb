 ...
 * generated in the com.pmsc.warning.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListWarnEventResponse_QNAME = new QName("http://service.warning.pmsc.com/", "listWarnEventResponse");
    ...
    private final static QName _ListWarnRegionInfoResponse_QNAME = new QName("http://service.warning.pmsc.com/", "listWarnRegionInfoResponse");
    ...
    private final static QName _ListWarnRegionInfo_QNAME = new QName("http://service.warning.pmsc.com/", "listWarnRegionInfo");
    private final static QName _ListWarnEvent_QNAME = new QName("http://service.warning.pmsc.com/", "listWarnEvent");
    private final static QName _GetMaxWarnId_QNAME = new QName("http://service.warning.pmsc.com/", "getMaxWarnId");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.pmsc.warning.service
     * 
     */
    ...
    /**
     * Create an instance of {@link ListWarnRegionInfo }
     * 
     */
    public ListWarnRegionInfo createListWarnRegionInfo() {
        return new ListWarnRegionInfo();
    }
    ...
    /**
     * Create an instance of {@link ListWarnEvent }
     * 
     */
    public ListWarnEvent createListWarnEvent() {
        return new ListWarnEvent();
    }
    ...
    /**
     * Create an instance of {@link ListWarnRegionInfoResponse }
     * 
     */
    public ListWarnRegionInfoResponse createListWarnRegionInfoResponse() {
        return new ListWarnRegionInfoResponse();
    }
    ...
    /**
     * Create an instance of {@link ListWarnEventResponse }
     * 
     */
    public ListWarnEventResponse createListWarnEventResponse() {
        return new ListWarnEventResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ListWarnEventResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.warning.pmsc.com/", name = "listWarnEventResponse")
    public JAXBElement<ListWarnEventResponse> createListWarnEventResponse(ListWarnEventResponse value) {
        return new JAXBElement<ListWarnEventResponse>(_ListWarnEventResponse_QNAME, ListWarnEventResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ListWarnRegionInfoResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.warning.pmsc.com/", name = "listWarnRegionInfoResponse")
    public JAXBElement<ListWarnRegionInfoResponse> createListWarnRegionInfoResponse(ListWarnRegionInfoResponse value) {
        return new JAXBElement<ListWarnRegionInfoResponse>(_ListWarnRegionInfoResponse_QNAME, ListWarnRegionInfoResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ListWarnRegionInfo }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.warning.pmsc.com/", name = "listWarnRegionInfo")
    public JAXBElement<ListWarnRegionInfo> createListWarnRegionInfo(ListWarnRegionInfo value) {
        return new JAXBElement<ListWarnRegionInfo>(_ListWarnRegionInfo_QNAME, ListWarnRegionInfo.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ListWarnEvent }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.warning.pmsc.com/", name = "listWarnEvent")
    public JAXBElement<ListWarnEvent> createListWarnEvent(ListWarnEvent value) {
        return new JAXBElement<ListWarnEvent>(_ListWarnEvent_QNAME, ListWarnEvent.class, null, value);
    }
