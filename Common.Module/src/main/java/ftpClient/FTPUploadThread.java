...
public class FTPUploadThread extends Thread {
	 ...
	 * @param localpath
	 */
	public FTPUploadThread(int period_seconds, String host, int port, String user, String password, boolean isTextMode,
			boolean isPassiveMode, String ftppath, String localpath) {
