...
public class LunarDate {
	...
	//2016年5月10日新增
	/** ob.MyLjq 节气，非指定日期，而是一段日期范围 */
	private String MylunarSolarTerm;
	/** ob.cur_dz 距冬至的天数 */
	...
	//2017年3月4日新增
	/** ob.Lyear3 干支年, 新年的判定, 春节[正月]为新年*/
	private String MycnEarYear;
	...
	//2016年5月10日新增
	public String getMyLunarSolarTerm() {
		return MylunarSolarTerm;
	}
	//2016年5月10日新增
	public void setMyLunarSolarTerm(String MylunarSolarTerm) {
		this.MylunarSolarTerm = MylunarSolarTerm;
	}
	...
	public String getMycnEarYear() {
		return MycnEarYear;
	}

	public void setMycnEarYear(String mycnEarYear) {
		this.MycnEarYear = mycnEarYear;
	}
