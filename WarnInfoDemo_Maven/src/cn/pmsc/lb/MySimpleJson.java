...
public class MySimpleJson {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(MySimpleJson.class);
...
//				logger.info("PostJSON(URL, Object) - post_obj=" + post_obj.toString()); //$NON-NLS-1$
//			}
            
			if (logger.isDebugEnabled()) {
				logger.debug("PostJSON(URL, Object) - post_obj=" + post_obj.toString()); //$NON-NLS-1$
			}
